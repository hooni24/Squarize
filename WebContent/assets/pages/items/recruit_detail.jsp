	          ...
	          <!--end Features-->
	                ...
	                <s:if test="#session.loginId != null && #session.loginId == sq_recruit_artist.sq_member_id">
                      <article class="center" id="test">
                          <a href="#" class="btn btn-circle btn-default btn-lg detail-btn" id="lists">목록</a>
                          <a href="#" class="btn btn-circle btn-default btn-lg detail-btn submit-button" data-expand-width="col-8" data-transition-parent=".content-loader" data-external="true" id="update-btn">수정</a>
	                ...
	                <s:elseif test="#session.loginId != null && #session.loginId != sq_recruit_artist.sq_member_id">
	                	<article class="center" id="test">
		                    <a id="applyThisRecruit" class="btn btn-circle btn-default btn-lg">지원</a>
		                </article>
	                </s:elseif>
