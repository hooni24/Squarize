               ...
               <!-- 지도에 위치 표시  -->
                   ...
                   <s:if test="#session.loginId != null && #session.loginId == sq_recruit_artist.sq_member_id">
                      <article class="center" id="test">
                          <a href="applied_list?sq_recruit_apply.sq_recruit_id=${sq_recruit_artist.sq_recruit_id}" class="btn btn-circle btn-default btn-lg detail-btn">목록</a>
                          <a href="recruit_update?sq_recruit.sq_recruit_id=${sq_recruit_artist.sq_recruit_id}" class="btn btn-circle btn-default btn-lg detail-btn submit-button" data-expand-width="col-8" data-transition-parent=".content-loader" data-external="true">수정</a>
                          <a href="deleteSQrecruit?sq_recruit.sq_recruit_id=${sq_recruit_artist.sq_recruit_id}" class="btn btn-circle btn-default btn-lg detail-btn submit-button" data-expand-width="col-8" data-transition-parent=".content-loader" data-external="true">삭제</a>
                      </article>
                   </s:if>
                   ...
                   <s:elseif test="#session.loginId != null && #session.loginId != sq_recruit_artist.sq_member_id">
                      <article class="center" id="test">
                          <a id="applyThisRecruit" class="btn btn-circle btn-default btn-lg detail-btn">지원</a>
                      </article>
                   </s:elseif>
