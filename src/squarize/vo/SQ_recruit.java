...
public class SQ_recruit {
	...
	public SQ_recruit(int sq_recruit_id, String sq_member_id, String sq_recruit_input_date, String sq_recruit_part,
			String sq_recruit_photo, String sq_recruit_genre, String sq_recruit_date, String sq_recruit_location,
			String sq_recruit_info, String sq_recruit_title) {
		super();
